...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(DL_GPIO_setPins(Gray_address_PORT,Gray_address_PIN_4_PIN)) : (DL_GPIO_clearPins(Gray_address_PORT,Gray_address_PIN_4_PIN)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(DL_GPIO_setPins(Gray_address_PORT,Gray_address_PIN_5_PIN)) : (DL_GPIO_clearPins(Gray_address_PORT,Gray_address_PIN_5_PIN)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(DL_GPIO_setPins(Gray_address_PORT,Gray_address_PIN_6_PIN)) : (DL_GPIO_clearPins(Gray_address_PORT,Gray_address_PIN_6_PIN)))// 地址位2控制
