    ...
    switch (DL_Interrupt_getPendingGroup(DL_INTERRUPT_GROUP_1)) {
        ...
        case GPIO_MULTIPLE_GPIOA_INT_IIDX:
            switch (DL_GPIO_getPendingInterrupt(GPIOA))
            {
               ...
               #if (defined GPIO_VL53L0X_PIN_VL53L0X_GPIO1_PORT) && (GPIO_VL53L0X_PIN_VL53L0X_GPIO1_PORT == GPIOA) && defined(GPIO_VL53L0X_PIN_VL53L0X_GPIO1_IIDX)
        ...
        case GPIO_MULTIPLE_GPIOB_INT_IIDX:
            switch (DL_GPIO_getPendingInterrupt(GPIOB))
            {
                ...
                #if (defined INT1_PORT) && (INT1_PORT == GPIOB)
                case INT1_PIN_8_IIDX:
                    ICM42688_NotifyDataReady();
                    break;
                #endif

                #if (defined GPIO_VL53L0X_PIN_VL53L0X_GPIO1_PORT) && (GPIO_VL53L0X_PIN_VL53L0X_GPIO1_PORT == GPIOB) && defined(GPIO_VL53L0X_PIN_VL53L0X_GPIO1_IIDX)
                case GPIO_VL53L0X_PIN_VL53L0X_GPIO1_IIDX:
                    Read_VL53L0X();
                    break;
                #endif
